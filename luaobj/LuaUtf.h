...
{
public:
	LuaUtfBuffer():m_bufPtr(m_stackBuf)
	{}
...
int LUAOBJ_API luaUTF16To8( char *pszUTF8, const unsigned short* pwszUTF16, int nUTF8Count );

int LUAOBJ_API luaUTF16To8( char *pszUTF8, int nUTF8Count, const unsigned short* pwszUTF16 ,int nUTF16Count);
...
int LUAOBJ_API luaUTF8To16( unsigned short* pwszUTF16, const char* pszUTF8, int nUTF8Count );

int LUAOBJ_API luaUTF8To16( unsigned short* pwszUTF16,int nUTF16Count,const char* pszUTF8, int nUTF8Count );
